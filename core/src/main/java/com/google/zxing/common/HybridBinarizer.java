...
public final class HybridBinarizer extends GlobalHistogramBinarizer {
  ...
  private static int[][] calculateBlackPoints(byte[] luminances,
    ...
    for (int y = 0; y < subHeight; y++) {
      ...
      for (int x = 0; x < subWidth; x++) {
        ...
        int min = 0xFF;
        int max = 0;
        int average = average(luminances, width, blackPoints, y, yoffset, x,xoffset, sum, min, max);
  ...
  private static int average(byte[] luminances, int width, int[][] blackPoints,int y, 
      int yoffset, int x, int xoffset, int sum, int min, int max) {
